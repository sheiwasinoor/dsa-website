...
export const LANDING_TEXT_MOBILE_SCALE = 0.8;
export const LANDING_TEXT_LETTER_SPACING_CN_ROW_MOBILE_SCALE = 0.7;
export const LANDING_TEXT_MEDIUM_SCALE = 0.8;
export const LANDING_VIDEO_MOBILE_SCALE = 0.8;
